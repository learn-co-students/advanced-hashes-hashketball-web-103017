...
def num_points_scored(player)
  game_hash.each do |location, team_info|
    team_info[:players].each do |details, stats|
      return stats[:points] if details == player
    end
  end
end
...
def player_numbers(team)
  game_hash.collect do |location, team_info|
    if team_info[:team_name] == team
      return team_info[:players].collect {|player, info| info[:number]}
    end
  end
end
...
def big_shoe_rebounds
  ...
  game_hash.each do |location, team_info|
    team_info[:players].each do |name, stats|
      return stats[:rebounds] if name == max_size_owner
    end
  end
